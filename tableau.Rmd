...
## Predicting High Risk Loans with Tableau and DataRobot
...
I whipped up the dashboard below to show for client demos. While it's neither my most sophisticated nor favorite creation, I think it looks and it shows the output of the models I built. IMO, great website fodder.

View it in full screen [here](https://public.tableau.com/app/profile/marshall3251/viz/LendingClubDefaultPredictor-DataRobot/MainDash?publish=yes){target="_blank"} (it's better and also loads faster)
